...
export const moon = Variable(0, {
    poll: [60*5000, '/home/sergio/.config/moonphase.py', n => {
        return JSON.parse(n);
    }],
});


export const sun = Variable(0, {
    poll: [60*6000, '/home/sergio/.config/sun.py', n => {
        return JSON.parse(n);
    }],
});

export const weat = Variable(0, {
    poll: [60*6000, '/home/sergio/.config/weather.py', n => {
        return JSON.parse(n);
    }],
});
export const temp = Variable(0, {
    poll: [6000, "/home/sergio/.config/temp.sh", n => {
       return n;
    }],
});
