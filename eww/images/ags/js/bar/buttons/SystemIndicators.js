...
const NetworkIndicator = () =>  Widget.Icon().hook(Network, self => {
    const icon = ((Network["primary"]=="wired")&&(Network["wired"]["state"]=="enabled"))?icons.network.wired1:icons.network.wired0;
    self.icon = icon || '';
    self.visible = !!icon;
});

const WifiIndicator = () => Widget.Icon().hook(Network, self => {
    const icon = ((Network["primary"]=="wifi")&&(Network["wifi"]["state"]=="enabled"))?icons.network.wifi1:icons.network.wifi0;
    self.icon = icon || '';
        self.size = 30;
